...
[![test checks](https://img.shields.io/badge/test_checks-271_passing-brightgreen)](#the-testing-story)
...
Correctness risk concentrates in the conflict/retry path, so that's where the tests concentrate — **271 checks across seven suites**, all run in CI on every push:
