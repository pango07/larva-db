...
| [`larva-architecture.excalidraw`](larva-architecture.excalidraw) | the editable source for those pictures — open at [excalidraw.com](https://excalidraw.com) |

The spec of record is [`../LARVA-DESIGN.md`](../LARVA-DESIGN.md); the quickstart is [`../LARVA-QUICKSTART.md`](../LARVA-QUICKSTART.md).
