...
2. **Intent queues + lease-elected cross-process group commit** — the ladder's rungs 4–5 below, promoted from exploration to committed; the pair ships together as the next format bump and removes the cross-instance write ceiling.
