...
Two schema features require format 2 (Section 5) because pre-v2 writers would mishandle them, and a store only declares format 2 when its schema actually uses one:
