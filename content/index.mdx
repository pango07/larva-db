...
- **No silently lost writes, ever.** Every commit goes through an atomic protocol; conflicts rebase, re-execute, or fail loudly. Verified by 275 checks including randomized concurrent-writer gauntlets.
