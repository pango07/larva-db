...
## The test suites — 343 checks across eight suites
...
| `group-commit-test.ts` | coalescing, the conflict matrix, the ordered commit log under chaos, exact decimals (format 5) |
